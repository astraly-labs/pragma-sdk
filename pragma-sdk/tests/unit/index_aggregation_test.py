...
from pragma_sdk.common.fetchers.handlers.index_aggregator_handler import AssetQuantities, IndexAggregation
...
@pytest.mark.parametrize("spot_entries,pair_quantities,expected", [
    (
